...
describe('AccountDetailsView', () => {
  it('renders a unified account detail table with party and completeness fields', () => {
    ...
    expect(source).toContain('openRuleDialog')
    expect(source).toContain('ruleDialogVisible')
    expect(source).toContain('saveInlineRule')
    expect(source).toContain("row.businessType === '需要规则匹配'")
    expect(source).toContain('配置匹配规则')
    expect(source).toContain('api.rules.create')
