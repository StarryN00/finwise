...
describe('LedgerView', () => {
  ...
  it('contains dense-table scroll containers and Chinese ledger labels', () => {
    ...
    expect(source).toContain('const yearOptions')
    expect(source).toContain('v-for="year in yearOptions"')
    expect(source).not.toContain('<el-input v-model="historicalFiscalYear"')
