...
export const api = {
  ...
  vouchers: {
    ...
    createPreprocessJob: (packageId) => apiClient.post(`/monthly-packages/${packageId}/voucher-preprocess-jobs`),
    latestPreprocessJob: (packageId) => apiClient.get(`/monthly-packages/${packageId}/voucher-preprocess-jobs/latest`),
    getPreprocessJob: (jobId) => apiClient.get(`/voucher-preprocess-jobs/${jobId}`),
    retryPreprocessJob: (jobId) => apiClient.post(`/voucher-preprocess-jobs/${jobId}/retry`),
    cancelPreprocessJob: (jobId) => apiClient.post(`/voucher-preprocess-jobs/${jobId}/cancel`),
